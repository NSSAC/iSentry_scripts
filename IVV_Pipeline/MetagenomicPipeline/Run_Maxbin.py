...
parser.add_argument("-r2","--read2",required=True,help="Reverse reads file")
...
maxbin_cmd = [maxbin,"-thread",args.threads,"-contig",args.contig,"-reads",args.read1,"-reads2",args.read2,"-out",args.prefix]
